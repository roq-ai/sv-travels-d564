...
import { getTripHistoryById } from 'apiSdk/trip-histories';
import { TripHistoryInterface } from 'interfaces/trip-history';

function TripHistoryViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('trip_history', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/trip-histories/edit/${id}`} passHref legacyBehavior>
                    <Button
